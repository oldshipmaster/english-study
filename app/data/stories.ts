...
const storyCatalog: Omit<Story, "learningPack">[] = [
  {
    ...
    lines: [
      ...
      { roleId: "mia", english: "How will we see in the dark?", chinese: "天这么黑，我们怎么看清呢？" },
      ...
      { roleId: "grandma", english: "Now the garden looks bright.", chinese: "现在花园看起来亮堂堂的。" },
  ...
  },
  {
    ...
    lines: [
      ...
      { roleId: "owl", english: "This map may show where the key is.", chinese: "这张地图也许标出了钥匙的位置。", vocabulary: ["map", "key"] },
      ...
      { roleId: "owl", english: "Walk carefully on the wooden boards.", chinese: "在木板上小心走。" },
    ...
    challenges: [
      ...
      { prompt: "What is in the chest?", options: ["Storybooks", "Stones", "Leaves"], answerIndex: 0, encouragement: "Brilliant teamwork!" },
    ],
  },
  {
    ...
    lines: [
      ...
      { roleId: "uncle", english: "Can we share the morning jobs?", chinese: "我们能分担早晨的任务吗？", vocabulary: ["share"] },
      ...
      { roleId: "uncle", english: "Busy mornings are easier when we work together.", chinese: "一起合作，忙碌的早晨就会轻松一些。", vocabulary: ["together"] },
    ],
    challenges: [
  ...
  },
  {
    ...
    lines: [
      ...
      { roleId: "ava", english: "Our class has so much talent!", chinese: "我们班真是人才济济！" },
    ],
    challenges: [
